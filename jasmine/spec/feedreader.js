...
$(function() {
	...
	*/
	...
	describe('New Feed Selection', function() {
		...
		beforeEach(function(done) {
			//Store the html content of the body before loading a new feed
			initialContent = htmlBody.html();
			loadFeed(1, done);
		});

		it('actually changes when new feed is loaded.', function(done) {
